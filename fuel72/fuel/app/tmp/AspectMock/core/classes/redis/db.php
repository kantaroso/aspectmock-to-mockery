...
class Redis_Db
{
    ...
    { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($pattern, $callback), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $args), false)) !== __AM_CONTINUE__) return $__am_res; 
