...
JS;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $var, $level, $indent_char, $scope), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($filepath, $line_num, $highlight, $padding), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($trace), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	*/
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($callable, $params), true)) !== __AM_CONTINUE__) return $__am_res; 
