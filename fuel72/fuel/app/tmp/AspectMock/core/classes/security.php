...
class Security
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($value, $options, $spec), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($value))
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($rotate), true)) !== __AM_CONTINUE__) return $__am_res; 
