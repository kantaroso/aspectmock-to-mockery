...
class Cli
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $value), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ($value === null)
		{
			if (isset(static::$args[$name]))
			{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($prefix), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($text, $foreground, $background), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($text))
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($seconds, $countdown), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ($countdown === true)
		{
			$time = $seconds;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($text, $foreground, $background, $format), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	*/
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($call, $output), true)) !== __AM_CONTINUE__) return $__am_res; 
		// Windows
		if(is_windows())
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($fh), true)) !== __AM_CONTINUE__) return $__am_res; 
		$orig = static::$STDERR;
