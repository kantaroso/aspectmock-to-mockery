...
class Arr
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$array, $key, $value), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_null($key))
		{
			$array = $value;
			return;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key, $index), true)) !== __AM_CONTINUE__) return $__am_res; 
		$return = array();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($array) and ! $array instanceof \ArrayAccess)
		{
			throw new \InvalidArgumentException('First parameter must be an array or ArrayAccess object.');
		}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($assoc, $key_field, $val_field), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key_field, $val_field), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($arr), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $glue, $reset, $indexed), true)) !== __AM_CONTINUE__) return $__am_res; 
		static $return = array();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $glue, $reset), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $glue), true)) !== __AM_CONTINUE__) return $__am_res; 
		$return = array();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $prefix, $remove_prefix), true)) !== __AM_CONTINUE__) return $__am_res; 
		$return = array();
		foreach ($array as $key => $val)
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $callback), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $prefix), true)) !== __AM_CONTINUE__) return $__am_res; 
		foreach ($array as $key => $val)
		{
			if (preg_match('/^'.$prefix.'/', $key))
			{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $suffix, $remove_suffix), true)) !== __AM_CONTINUE__) return $__am_res; 
		$return = array();
		foreach ($array as $key => $val)
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $suffix), true)) !== __AM_CONTINUE__) return $__am_res; 
		foreach ($array as $key => $val)
		{
			if (preg_match('/'.$suffix.'$/', $key))
			{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $keys, $remove), true)) !== __AM_CONTINUE__) return $__am_res; 
		$return = array();
		foreach ($keys as $key)
		{
			if (array_key_exists($key, $array))
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$original, $value, $pos), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$original, $values, $pos), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (count($original) < abs($pos))
		{
			return false;
		}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$original, $value, $key, $is_assoc), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$original, $value, $search, $is_assoc), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key, $order, $sort_flags), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($array))
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $conditions, $ignore_case), true)) !== __AM_CONTINUE__) return $__am_res; 
		$temp = array();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($source, $replace, $new_key), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array(&$arr, $key, $value), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($needle, $haystack, $strict), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($arr, $all_keys), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $value, $default, $recursive, $delimiter, $strict), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($array) and ! $array instanceof \ArrayAccess)
		{
			throw new \InvalidArgumentException('First parameter must be an array or ArrayAccess object.');
		}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $key, $get_value, $strict), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($array) and ! $array instanceof \ArrayAccess)
		{
			throw new \InvalidArgumentException('First parameter must be an array or ArrayAccess object.');
		}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $value, $get_value, $strict), true)) !== __AM_CONTINUE__) return $__am_res; 
		if ( ! is_array($array) and ! $array instanceof \ArrayAccess)
		{
			throw new \InvalidArgumentException('First parameter must be an array or ArrayAccess object.');
		}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($array, $keys, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
		$result = array();
