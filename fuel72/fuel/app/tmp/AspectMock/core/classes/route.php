...
class Route
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($path, $translation, $case_sensitive, $strip_extension, $name), false)) !== __AM_CONTINUE__) return $__am_res; 
		$this->path = $path;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($uri, $named_params), false)) !== __AM_CONTINUE__) return $__am_res; 
