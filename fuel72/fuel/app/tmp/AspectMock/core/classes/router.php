...
class Router
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $options, $prepend, $case_sensitive), true)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_array($path))
		{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $named_params), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($path, $case_sensitive), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($request, $route), true)) !== __AM_CONTINUE__) return $__am_res; 
		$match = false;
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($match), true)) !== __AM_CONTINUE__) return $__am_res; 
		$namespace = '';
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($segments, $namespace, $module), true)) !== __AM_CONTINUE__) return $__am_res; 
