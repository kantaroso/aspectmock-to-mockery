...
class Fuel
{
	...
	final private function __construct() { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array(), false)) !== __AM_CONTINUE__) return $__am_res;  }
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($file), true)) !== __AM_CONTINUE__) return $__am_res; 
		return include \Go\Instrument\Transformer\FilterInjectorTransformer::rewrite( $file, '/var/www/fuel/core/classes');
	}
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($var), true)) !== __AM_CONTINUE__) return $__am_res; 
