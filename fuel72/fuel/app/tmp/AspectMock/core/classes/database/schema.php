...
class Database_Schema
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name, $connection), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($database, $charset, $if_not_exists), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'CREATE DATABASE';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($database), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'DROP DATABASE ';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $new_table_name), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'RENAME TABLE ';
		$sql .= $this->_connection->quote_identifier($this->_connection->table_prefix($table));
		$sql .= ' TO ';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $fields, $primary_keys, $if_not_exists, $engine, $charset, $foreign_keys), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'CREATE TABLE';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $index_columns, $index_name, $index), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $index_name), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $foreign_key), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $fk_name), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'ALTER TABLE ';
		$sql .= $this->_connection->quote_identifier($this->_connection->table_prefix($table)).' ';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($foreign_keys), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($type, $table, $fields), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql = 'ALTER TABLE '.$this->_connection->quote_identifier($this->_connection->table_prefix($table)).' ';
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($operation, $table), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($charset, $is_default, $collation), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($fields, $prefix), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sql_fields = array();
