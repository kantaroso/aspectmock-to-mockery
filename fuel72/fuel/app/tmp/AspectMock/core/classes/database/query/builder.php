...
abstract class Database_Query_Builder extends \Database_Query
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($db, $joins), false)) !== __AM_CONTINUE__) return $__am_res; 
		$statements = array();
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($db, $conditions), false)) !== __AM_CONTINUE__) return $__am_res; 
		$last_condition = NULL;
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($db, $values), false)) !== __AM_CONTINUE__) return $__am_res; 
		$set = array();
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($db, $columns), false)) !== __AM_CONTINUE__) return $__am_res; 
		$sort = array();
