...
abstract class Database_Connection
{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($args), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($operation, $params), false)) !== __AM_CONTINUE__) return $__am_res; 
