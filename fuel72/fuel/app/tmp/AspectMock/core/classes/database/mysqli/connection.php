...
//		$this->_schema = new \Database_Drivername_Schema($name, $this);
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($charset), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($type, $sql, $as_object, $caching), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($like), false)) !== __AM_CONTINUE__) return $__am_res; 
		if (is_string($like))
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($table, $like), false)) !== __AM_CONTINUE__) return $__am_res; 
	 ...
	 */
	protected function set_savepoint($name) { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name), false)) !== __AM_CONTINUE__) return $__am_res; 
	 ...
	 *                 false - failed to set savepoint;
	 */
	protected function release_savepoint($name) { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name), false)) !== __AM_CONTINUE__) return $__am_res; 
	 ...
	 *                 false - failed to set savepoint;
	 */
	protected function rollback_savepoint($name) { if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($name), false)) !== __AM_CONTINUE__) return $__am_res; 
