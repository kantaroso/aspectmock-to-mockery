...
class Model implements \ArrayAccess, \Iterator, \Sanitization
{
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($data, $new, $view, $cache), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($writeable), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($type), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($obj, $class), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($data), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($key, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($specific), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($relation), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($specific, $default), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($name, $options), true)) !== __AM_CONTINUE__) return $__am_res; 
		$class = get_called_class();
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($id, $options), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($options), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($key), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($data, $new, $view, $cache), false)) !== __AM_CONTINUE__) return $__am_res; 
		...
		if ( ! is_array($data) and ! $data instanceOf \ArrayAccess)
		{
			throw new \ErrorException(
				...
				0, E_ERROR, '/var/www/fuel/packages/orm/classes/model.php', __LINE__-7 // adjust the line to point to the function prototype, not this line!
			);
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($original), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($relations), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($rels), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($rels === false)
		{
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($property, $value), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($property, $conditions), false)) !== __AM_CONTINUE__) return $__am_res; 
		// database columns
		if (array_key_exists($property, static::properties()))
		{
			if ( ! array_key_exists($property, $this->_data))
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($cascade, $use_transaction), false)) !== __AM_CONTINUE__) return $__am_res; 
		if ($this->frozen())
		{
			return false;
		}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($rel), false)) !== __AM_CONTINUE__) return $__am_res; 
		return true;
	}
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($property, $observe), false)) !== __AM_CONTINUE__) return $__am_res; 
		$properties = static::properties();
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($relation), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($field, $value), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before(get_called_class(), __CLASS__, __FUNCTION__, array($form, $instance), true)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($custom, $recurse, $eav), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($custom, $recurse), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($attribute, $isset, $unset), false)) !== __AM_CONTINUE__) return $__am_res; 
	...
	{ if (($__am_res = __amock_before($this, __CLASS__, __FUNCTION__, array($attribute, $value), false)) !== __AM_CONTINUE__) return $__am_res; 
		// get the current class name
		$class = get_called_class();
